...
function configureTexture() {
    ...
    blackColor = new Uint8Array([0,0,0,100]);
...
function render()
{
    ...
    sModelViewMatrix = mult(modelViewMatrix, translate(light[0], light[1]-1.001, light[2]));
    sModelViewMatrix = mult(sModelViewMatrix, m);
    sModelViewMatrix = mult(sModelViewMatrix, translate(-light[0], -(light[1]-1.001), -light[2]));
