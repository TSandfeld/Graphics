...
var lightDirection = vec4(0.0, 0.0, -750.0, 0.0);
...
function computeProducts() {
    ...
    gl.uniform4fv( gl.getUniformLocation(program, "adsProduct"), flatten(adsProduct));
    gl.uniform4fv( gl.getUniformLocation(program, "lightPosition"), flatten(lightDirection));
    gl.uniform1f( gl.getUniformLocation(program, "shininess"), matShiny);
}
